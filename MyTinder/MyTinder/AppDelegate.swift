...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        if Session.getSingleton.isUserLoggedIn() {
            // load storyboard
//            let storyboard = UIStoryboard(name: "AfterLogin", bundle: Bundle.main)
//            
//            // load view controller with the storyboardID of ChatListViewController
//            let ChatListViewController = storyboard.instantiateViewController(withIdentifier: "HomeVC")
//            
