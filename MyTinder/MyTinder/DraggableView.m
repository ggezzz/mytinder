...
#warning placeholder stuff, replace with card-specific information {
        ...
        [profilePhoto sd_setImageWithURL:[NSURL URLWithString:information.text]
                     placeholderImage:[UIImage imageNamed:@"avatar-2"]];
        
        
        //profilePhoto.image = [UIImage imageNamed:@"avatar-2"];
        profilePhoto.clipsToBounds = true;
        profilePhoto.layer.cornerRadius = 10.0;
